...
<!-- это написано на сайте: https://paiza.io/projects/4trCBue4hKncnNkvmuQ4kQ?language=php -->
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>April 2023 - <span
                class="w3-tag w3-teal w3-round">Current</span></h6>
            <p>Работала в компании бухгалтером.</p>
            <hr>
          </div>
          <div class="w3-container">
            <h5 class="w3-opacity"><b>Web Developer / something.com</b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>April 2012 - Dec 2018</h6>
            <p>Работала в компании Комус бухгалтером.</p>
            <hr>
          </div>
          <div class="w3-container">
...
$job = [
'job_name' => ['GB', 'ПТК Групп', 'Комус'],
'job_data' => ['2023-настоящее время', '2019-2023', '2012-2018'],
'job_desc' => ['Много интересной работы', 'Разная работа - бухгалтер, финансист', 'Бухгалтер']
]
?>
